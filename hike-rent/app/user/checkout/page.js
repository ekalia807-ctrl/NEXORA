          ...
          <div className="rounded-2xl border border-line bg-white/80 p-5 sm:p-6 lg:p-7 shadow-sm backdrop-blur-sm space-y-5">
            ...
            <div>
              ...
              <input
                ...
                className={`mt-1.5 w-full rounded-xl border px-4 py-2.5 text-sm text-ink outline-none transition-all ${errors.name
            ...
            <div>
              ...
              <input
                ...
                className={`mt-1.5 w-full rounded-xl border px-4 py-2.5 font-mono text-sm text-ink outline-none transition-all ${errors.whatsapp
                    ? "border-alert bg-alert/5 focus:border-alert focus:bg-white focus:ring-2 focus:ring-alert/20"
                    : "border-line bg-paper/60 focus:border-ridge focus:bg-white focus:ring-2 focus:ring-ridge/10"
                  }`}
              />
            ...
            <div className="border-t border-line/50 pt-4">
              ...
              <div
                className={`mt-2 rounded-xl border p-3 transition-all ${errors.ktp
